...
return [
    ...
    'description' => [
         ...
         */
        'fallback' => 'Website Resmi Badan Eksekutif Mahasiswa (BEM) Fakultas Teknik Universitas Diponegoro',
    ],
    ...
    'twitter' => [
         ...
         */
        '@username' => 'https://twitter.com/bemftundip',
    ],
];
